(function (global, factory) {
  ...
  var getLoaderDiv = function getLoaderDiv() {
    // --->>>
    ...
    loaderDiv.style.setProperty('justify-content', 'center'); // Style animation div
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 8:
                ...
                this._container.append(getLoaderDiv()); // React to resize events on window
  ...
  var Sun = /*#__PURE__*/function (_AbstractToyModel) {
    ...
    function Sun() {
      ...
      _this.sprite.scale.multiplyScalar(sunRadiusMeters * imageToSunRatio);

      _this.model.add(_this.sprite); // Set up helper


      _this.helper = new THREE.LineSegments(new THREE.EdgesGeometry(new THREE.SphereGeometry(sunRadiusMeters, 32)), new THREE.LineBasicMaterial({
  ...
  var Planet = /*#__PURE__*/function (_AbstractToyModel) {
    ...
    function Planet(NAME) {
      ...
      _this.orbit = new Orbit(_this.NAME, EOrbitalType.PLANET);
  ...
  var Asteroid = /*#__PURE__*/function (_AbstractToyModel) {
    ...
    function Asteroid(name, radius) {
      ...
      _this = _AbstractToyModel.call(this, 30000) || this;
  ...
  var SceneManager = /*#__PURE__*/function (_AbstractSceneManager) {
    ...
    function SceneManager(containerId) {
      ...
      _this.starField = new StarField(auToMeters(999)); // Register scene entities

      _this.registerSceneEntities([_this.starField].concat(_this.planets, [new DirectionalLight(), new MiscHelpers(), new SimpleLight(0.4), new PointLight(5, planetData.SUN.radiusMeters), // ...this.asteroids,
      ...
      _this._postInitHook = function () {
        ...
        349450170005.93274, 1508896562129.965, 622420704159.6792);
