(function (global, factory) {
  ...
  var AbstractSceneManager = /*#__PURE__*/function () {
    ...
    _proto.init = /*#__PURE__*/function () {
      var _init = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
        ...
        var initDate, DPR, initiatedSceneEntityGroups, dt;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                initDate = new Date(); // Enable superclass constructor to adjust settings prior to initialization sequence
  ...
  var getTextureFromImageUrl = function getTextureFromImageUrl(url, _name) {
  ...
  var AbstractToyModel = /*#__PURE__*/function (_AbstractSceneEntity) {
    ...
    function AbstractToyModel(_name, _radius, options) {
      var _this;
      ...
      _this._geometry = new THREE.SphereGeometry(_this._radius, sphereSegments, sphereSegments);

      _this._geometry.rotateX(Math.PI / 2);

      _this._wires = new THREE.LineSegments(new THREE.EdgesGeometry(_this._geometry), new THREE.LineBasicMaterial());
      _this._wires.userData.isHelper = true;
      _this._material = new THREE.MeshPhongMaterial();
      _this._model = new THREE.Mesh(_this._geometry, _this._material);
      _this._model.receiveShadow = true;
      _this._model.castShadow = true;
      _this._model.name = _this._name; //

      _this._sceneEntityGroup.name = _this._name;

      _this._sceneEntityGroup.add(_this._model);

      _this._sceneEntityGroup.add(_this._wires);
    ...
    _proto._setToToyScale = function _setToToyScale() {
      ...
      if (this._model) this._model.scale.set(t, t, t);
    ...
    _proto._updateMeshScale = function _updateMeshScale() {
      ...
      var _this$_model$scale = this._model.scale,
          sx = _this$_model$scale.x,
          sy = _this$_model$scale.y,
          sz = _this$_model$scale.z;
      ...
      if (sx < t) {
        ...
        this._model.scale.set(sx + ds, sy + ds, sz + ds);
  ...
  var sunRadiusMeters = planetData.SUN.radiusMeters;
  ...
  var Sun = /*#__PURE__*/function (_AbstractToyModel) {
    ...
    function Sun() {
      ...
      _this = _AbstractToyModel.call(this, 'SUN', sunRadiusMeters, {
                    ...
                    return runtime_1.wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            _context.next = 2;
                            return getTextureFromImageUrl(imageBaseUrl + "/stars/sun-sprite-512.png");
                          ...
                          case 2:
                            ...
                            _this2._model.visible = false; // Overwrite representation of sun with sprite in place of sphere
                            // AbstractToyMesh will then handle scaling of sprite

                            // Overwrite representation of sun with sprite in place of sphere
                            // AbstractToyMesh will then handle scaling of sprite
                            _this2._model = sprite; // Reregister sun but as sprite

                            // Reregister sun but as sprite
                            _this2._sceneEntityGroup.name = _this2.name;

                            _this2._sceneEntityGroup.add(_this2._model);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                contextResult = canvasResult.getContext('2d'); // load earthcloudmap

                imageMap = new Image();
                imageMap.crossOrigin = 'Anonymous';
                geometry = new THREE.SphereGeometry(cloudPlanetRadius, 32, 32, Math.PI / 2);
                ...
                document.body.append(canvasResult);
  ...
  var AbstractOrbital = /*#__PURE__*/function (_AbstractToyModel) {
    _inheritsLoose(AbstractOrbital, _AbstractToyModel);

    function AbstractOrbital(_name, _orbitalType, radius, toyScale) {
      var _this;

      _this = _AbstractToyModel.call(this, _name, radius, {
        toyScale: toyScale,
        realScale: 1,
  ...
  function GLTFLoader$1(gltfUrl, // cbOnReady: (obj: THREE.Group) => void,
  targetRadius, isCenteredOnBoundingBox, isShadowShown) {
    // ----------------->>>
    return new Promise(function (resolve) {
      new GLTFLoader().load(gltfUrl, function (gltf) {
        ...
        if (!!isShadowShown) enshadowChildren(object); // cbOnReady(object); // Signal object readiness
  ...
  var planetsAsLoadableObjects = ['HAUMEA'];
  /**
  ...
  var Planet = /*#__PURE__*/function (_AbstractOrbital) {
    ...
    function Planet(name) {
      ...
      _this = _AbstractOrbital.call(this, name, EOrbitalType.PLANET, getPlanetRadiusMeters(name), getPlanetToyScale(name)) || this;
      _this.name = name;
      return _this;
    }
                      ...
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            ...
                            _context2.next = 4;
                            return getTextureFromImageUrl(imageBaseUrl + "/planets/" + name + "/" + name + "-map-1024.jpg");

                          case 4:
                            _this2._material.map = _context2.sent;
                            // Make planet surface somewhat dull
                            _this2._material.shininess = 2;

                          case 6:
                            if (!planetsWithBumpMaps.includes(_this2.name)) {
                              _context2.next = 12;
                              break;
                            }

                            _context2.next = 9;
                            return getTextureFromImageUrl(imageBaseUrl + "/planets/" + name + "/" + name + "-bump-1024.png");

                          case 9:
                            _this2._material.bumpMap = _context2.sent;
                            // BumpScale needs to be on order of radius since we deal with such large numbers
                            _this2._material.bumpScale = _this2._radius * 50;

                            if (_this2._model instanceof THREE.Mesh) {
                              _this2._model.material = _this2._material;
                            }

                          case 12:
                            if (!(_this2.name === 'EARTH')) {
                              _context2.next = 21;
                              break;
                            }

                            _context2.next = 15;
                            return getTextureFromImageUrl(imageBaseUrl + "/planets/earth/earth-specular-1024.png");

                          case 15:
                            _this2._material.specularMap = _context2.sent;
                            _this2._material.shininess = 25; // Add clouds

                            _context2.next = 19;
                            return createEarthCloudMesh(crf * _this2._radius);

                          case 19:
                            _this2._clouds = _context2.sent;
                            if (!!_this2._clouds) _this2._sceneEntityGroup.add(_this2._clouds);

                          case 21:
                            if (planetsAsLoadableObjects.includes(_this2.name)) {
                              xxx = /*#__PURE__*/function () {
                                  ...
                                  return runtime_1.wrap(function _callee$(_context) {
                                    while (1) {
                                      switch (_context.prev = _context.next) {
                                        case 0:
                                          _context.next = 2;
                                          return GLTFLoader$1(imageBaseUrl + "/planets/" + name + "/" + name + ".glb", _this2._radius);

                                        case 2:
                                          obj = _context.sent;
                                          // Wrap loaded object in group so that its scale not get overwritten by toy-model mechanism
                                          objGroup = new THREE.Group();
                                          objGroup.add(obj);
                                          _this2._model = objGroup;
    ...
    _proto.update = function update(_tCenturiesSinceJ2000) {
      ...
      this._model.rotateZ(0.0015);

      if (!!this._clouds) this._clouds.rotateZ(0.0012); // if (!!this._clouds) this._clouds.rotateY(-0.0002);
    };
                    ...
                    return runtime_1.wrap(function _callee$(_context) {
                      while (1) {
                        switch (_context.prev = _context.next) {
                          case 0:
                            _context.next = 2;
                            return getTextureFromImageUrl( // `${imageBaseUrl}/stars/galaxy-starfield-4096.jpg`,
                            imageBaseUrl + "/stars/galaxy_starfield3.jpg");
  ...
  var SceneManager = /*#__PURE__*/function (_AbstractSceneManager) {
    ...
    function SceneManager(containerId) {
      ...
      _this.planets = [new Planet('MERCURY'), new Planet('VENUS'), new Planet('EARTH'), new Planet('MARS'), new Planet('CERES'), new Planet('JUPITER'), new Planet('SATURN'), new Planet('URANUS'), new Planet('NEPTUNE'), // new Planet('PLUTO'),
      new Planet('HAUMEA')];
      _this.asteroids = [new Asteroid('65P')]; // Register scene entities

      _this.registerSceneEntities([// new DirectionalLight(),
      new MiscHelpers(), new SimpleLight(3)].concat(_this.planets, _this.asteroids, [_this.starField,
      ...
      _this._postInitHook = function () {
        ...
        // 3906449321.9052143
        // Haumea
        -4514678652999.103, -996799575287.2986, 1431642047889.7205);
