        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              this._controls = new OrbitControls.OrbitControls(this._camera, this._renderer.domElement);
...
var Orbit = /*#__PURE__*/function () {
  ...
  _proto.getTail = function getTail(radius, tailLength, tCenturiesSinceJ200) {
    ...
    var realGeometry = BufferGeometryUtils.BufferGeometryUtils.mergeBufferGeometries(geometries.map(function (el) {
      return el.realSegmentGeometry;
    }), true);
    var loggedGeometry = BufferGeometryUtils.BufferGeometryUtils.mergeBufferGeometries(geometries.map(function (el) {
...
var settingsPanelId = 'settings-panel-id-' + /*#__PURE__*/uuid.v4();
/**
