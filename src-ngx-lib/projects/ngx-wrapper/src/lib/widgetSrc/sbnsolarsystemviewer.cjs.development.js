...
var keplerUtils = require('kepler-utils');
var SpriteMaterial = require('three/src/materials/SpriteMaterial');
...
var AbstractToyMesh = /*#__PURE__*/function (_AbstractSceneEntity) {
  ...
  function AbstractToyMesh(_name, _radius, options) {
    ...
    _this._wireframe = new THREE.LineSegments(new THREE.EdgesGeometry(_this._geometry), new THREE.LineBasicMaterial());
    _this._wireframe.userData.isHelper = true;
    _this._material = new THREE.MeshPhongMaterial(); // this._material = new THREE.MeshStandardMaterial();

    _this._mesh = new THREE.Mesh(_this._geometry, _this._material);
...
function createEarthCloudMesh(cloudPlanetRadius) {
  ...
  return new Promise(function (resolve) {
    ...
    var geometry = new THREE.SphereGeometry(cloudPlanetRadius, 32, 32);
...
var Orbit = /*#__PURE__*/function () {
  function Orbit(name, orbitalType) {
    ...
    this.projectedOrbitMaterial = new THREE.LineBasicMaterial({
      linewidth: 2,
      color: 'white'
    });
    this.projectedOrbitLine = new THREE.Line(new THREE.BufferGeometry(), this.projectedOrbitMaterial);

    this.loadPlanet = function () {
      _this.projectedOrbitMaterial.color = new THREE.Color('white');
    ...
    this.loadAsteroid = function () {
      _this.projectedOrbitMaterial.color = new THREE.Color('cyan');
  ...
  _proto.calcRevolutionPath = function calcRevolutionPath(tCenturiesSinceJ200) {
    ...
    this.projectedOrbitLine.geometry = new THREE.BufferGeometry().setFromPoints(this.projectedOrbitPoints);
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        ...
                        case 7:
                          ...
                          _this2._material = new THREE.MeshStandardMaterial({
                            // ambient: 0x00aa00,
                            color: 0x00aa00,
                            bumpMap: bumpTexture,
                            bumpScale: 1
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              return _context.abrupt("return", new Promise(function (resolve) {
                // Create light
                _this2._light = new THREE.DirectionalLight(0xffffff, 10);
...
var SceneManager = /*#__PURE__*/function (_AbstractSceneManager) {
  ...
  function SceneManager(containerId) {
    ...
    _this._updateCamera = function (_time) {
      ...
      if (_this._controls instanceof TrackballControls.TrackballControls) (_this$_controls = _this._controls) == null ? void 0 : _this$_controls.update();
...
exports.init = init;
//# sourceMappingURL=sbnsolarsystemviewer.cjs.development.js.map
