(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('three'), require('julian'), require('react-icons/fi'), require('react-icons/ai'), require('react-icons/io'), require('react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'three', 'julian', 'react-icons/fi', 'react-icons/ai', 'react-icons/io', 'react'], factory) :
  (global = global || self, factory(global.SbnSolarSystemViewer = {}, global.THREE, global.julian, global.fi, global.ai, global.io, global.React));
}(this, (function (exports, THREE, julian, fi, ai, io, React) { 'use strict';
